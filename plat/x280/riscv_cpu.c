...
#elif defined (__METAL_DT_SIFIVE_CLIC0_HANDLE)
...
__METAL_DEFINE_VTABLE(__metal_driver_vtable_cpu) = {
    ...
    .cpu_vtable.mcycle_timebase_get = __metal_driver_cpu_clock_timebase_get,
    .cpu_vtable.mtime_get = __metal_driver_cpu_mtime_get,
    .cpu_vtable.mtime_timebase_get = __metal_driver_cpu_mtime_timebase_get,
    ...
    .cpu_vtable.is_worldguard_aware = __metal_driver_cpu_is_worldguard_aware,
