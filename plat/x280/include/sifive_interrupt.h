...
struct metal_interrupt_vtable {
    ...
    int (*interrupt_clock_gating_enable)(struct metal_interrupt *controller);
    int (*interrupt_clock_gating_disable)(struct metal_interrupt *controller);
    int (*interrupt_clock_gating_get_state)(struct metal_interrupt *controller);
};
...
/*!
 * @brief Enable clock gating feature
 * @param controller The handle for the interrupt controller
 * @return 0 upon success
 */
__inline__ int metal_interrupt_clock_gating_enable(struct metal_interrupt *controller)
{
    return controller->vtable->interrupt_clock_gating_enable(controller);
}

/*!
 * @brief Disable clock gating feature
 * @param controller The handle for the interrupt controller
 * @return 0 upon success
 */
__inline__ int metal_interrupt_clock_gating_disable(struct metal_interrupt *controller)
{
    return controller->vtable->interrupt_clock_gating_disable(controller);
}

/*!
 * @brief Return clock gating feature enable state
 * @param controller The handle for the interrupt controller
 * @return 0 when disabled, nonzero when enabled
 */
__inline__ int metal_interrupt_clock_gating_get_state(struct metal_interrupt *controller)
{
    return controller->vtable->interrupt_clock_gating_get_state(controller);
}
