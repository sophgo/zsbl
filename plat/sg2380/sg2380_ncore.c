...
void sg2380_ncore_init(void)
{
	...
	mmio_write_32(0x50830003c0,0x00000003); //Active Memory Interleave Group Register 
	mmio_write_32(0x50830003c4,0x00000100); //Memory Interleave Function Select Register 
	mmio_write_32(0x5083000400,0x81400000); //General Purpose Region Attribute Register
	mmio_write_32(0x5083000404,0x00000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x5083000408,0x00000000); //General Purpose Region addr high 51:44
	mmio_write_32(0x5083000410,0x01600200); //General Purpose Region Attribute Register
	mmio_write_32(0x5083000414,0x01000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x5083000418,0x00000000); //General Purpose Region addr high 51:44
	...
	mmio_write_32(0x50830013c0,0x00000003); //Active Memory Interleave Group Register 
	mmio_write_32(0x50830013c4,0x00000100); //Memory Interleave Function Select Register 
	mmio_write_32(0x5083001400,0x81400000); //General Purpose Region Attribute Register
	mmio_write_32(0x5083001404,0x00000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x5083001408,0x00000000); //General Purpose Region addr high 51:44
	mmio_write_32(0x5083001410,0x01600200); //General Purpose Region Attribute Register
	mmio_write_32(0x5083001414,0x01000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x5083001418,0x00000000); //General Purpose Region addr high 51:44
	...
	mmio_write_32(0x50830023c0,0x00000003); //Active Memory Interleave Group Register 
	mmio_write_32(0x50830023c4,0x00000100); //Memory Interleave Function Select Register 
	mmio_write_32(0x5083002400,0x81400000); //General Purpose Region Attribute Register
	mmio_write_32(0x5083002404,0x00000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x5083002408,0x00000000); //General Purpose Region addr high 51:44
	mmio_write_32(0x5083002410,0x01600200); //General Purpose Region Attribute Register
	mmio_write_32(0x5083002414,0x01000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x5083002418,0x00000000); //General Purpose Region addr high 51:44
	...
	mmio_write_32(0x50830033c0,0x00000003); //Active Memory Interleave Group Register 
	mmio_write_32(0x50830033c4,0x00000100); //Memory Interleave Function Select Register 
	mmio_write_32(0x5083003400,0x81400000); //General Purpose Region Attribute Register
	mmio_write_32(0x5083003404,0x00000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x5083003408,0x00000000); //General Purpose Region addr high 51:44
	mmio_write_32(0x5083003410,0x01600200); //General Purpose Region Attribute Register
	mmio_write_32(0x5083003414,0x01000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x5083003418,0x00000000); //General Purpose Region addr high 51:44
	...
	mmio_write_32(0x50830043c0,0x00000003); //Active Memory Interleave Group Register 
	mmio_write_32(0x50830043c4,0x00000100); //Memory Interleave Function Select Register 
	mmio_write_32(0x5083004400,0x81400000); //General Purpose Region Attribute Register
	mmio_write_32(0x5083004404,0x00000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x5083004408,0x00000000); //General Purpose Region addr high 51:44
	mmio_write_32(0x5083004410,0x01600200); //General Purpose Region Attribute Register
	mmio_write_32(0x5083004414,0x01000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x5083004418,0x00000000); //General Purpose Region addr high 51:44
	...
	mmio_write_32(0x50830053c0,0x00000003); //Active Memory Interleave Group Register 
	mmio_write_32(0x50830053c4,0x00000100); //Memory Interleave Function Select Register 
	mmio_write_32(0x5083005400,0x81400000); //General Purpose Region Attribute Register
	mmio_write_32(0x5083005404,0x00000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x5083005408,0x00000000); //General Purpose Region addr high 51:44
	mmio_write_32(0x5083005410,0x01600200); //General Purpose Region Attribute Register
	mmio_write_32(0x5083005414,0x01000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x5083005418,0x00000000); //General Purpose Region addr high 51:44
	...
	mmio_write_32(0x50830063c0,0x00000003); //Active Memory Interleave Group Register 
	mmio_write_32(0x50830063c4,0x00000100); //Memory Interleave Function Select Register 
	mmio_write_32(0x5083006400,0x81400016); //General Purpose Region Attribute Register
	mmio_write_32(0x5083006404,0x00000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x5083006408,0x00000000); //General Purpose Region addr high 51:44
	mmio_write_32(0x5083006410,0x01600216); //General Purpose Region Attribute Register
	mmio_write_32(0x5083006414,0x01000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x5083006418,0x00000000); //General Purpose Region addr high 51:44
	...
	mmio_write_32(0x50830073c0,0x00000003); //Active Memory Interleave Group Register 
	mmio_write_32(0x50830073c4,0x00000100); //Memory Interleave Function Select Register 
	mmio_write_32(0x5083007400,0x81400000); //General Purpose Region Attribute Register
	mmio_write_32(0x5083007404,0x00000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x5083007408,0x00000000); //General Purpose Region addr high 51:44
	mmio_write_32(0x5083007410,0x01600200); //General Purpose Region Attribute Register
	mmio_write_32(0x5083007414,0x01000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x5083007418,0x00000000); //General Purpose Region addr high 51:44
	mmio_write_32(0x5083007c00,0x00000004); //Credit
	mmio_write_32(0x5083007c04,0x00000004); //Credit
	mmio_write_32(0x5083007c08,0x00000004); //Credit
	mmio_write_32(0x5083007c0c,0x00000004); //Credit
	mmio_write_32(0x5083007c10,0x00000004); //Credit
	mmio_write_32(0x5083007c14,0x00000004); //Credit
	mmio_write_32(0x5083007c18,0x00000004); //Credit
	mmio_write_32(0x5083007c1c,0x00000004); //Credit
	...
	mmio_write_32(0x50830083c0,0x00000003); //Active Memory Interleave Group Register 
	mmio_write_32(0x50830083c4,0x00000100); //Memory Interleave Function Select Register 
	mmio_write_32(0x5083008400,0x81400000); //General Purpose Region Attribute Register
	mmio_write_32(0x5083008404,0x00000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x5083008408,0x00000000); //General Purpose Region addr high 51:44
	mmio_write_32(0x5083008410,0x01600200); //General Purpose Region Attribute Register
	mmio_write_32(0x5083008414,0x01000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x5083008418,0x00000000); //General Purpose Region addr high 51:44
	mmio_write_32(0x5083008c00,0x00000004); //Credit
	mmio_write_32(0x5083008c04,0x00000004); //Credit
	mmio_write_32(0x5083008c08,0x00000004); //Credit
	mmio_write_32(0x5083008c0c,0x00000004); //Credit
	mmio_write_32(0x5083008c10,0x00000004); //Credit
	mmio_write_32(0x5083008c14,0x00000004); //Credit
	mmio_write_32(0x5083008c18,0x00000004); //Credit
	mmio_write_32(0x5083008c1c,0x00000004); //Credit
	...
	mmio_write_32(0x50830093c0,0x00000003); //Active Memory Interleave Group Register 
	mmio_write_32(0x50830093c4,0x00000100); //Memory Interleave Function Select Register 
	mmio_write_32(0x5083009400,0x81400000); //General Purpose Region Attribute Register
	mmio_write_32(0x5083009404,0x00000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x5083009408,0x00000000); //General Purpose Region addr high 51:44
	mmio_write_32(0x5083009410,0x01600200); //General Purpose Region Attribute Register
	mmio_write_32(0x5083009414,0x01000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x5083009418,0x00000000); //General Purpose Region addr high 51:44
	mmio_write_32(0x5083009c00,0x00000004); //Credit
	mmio_write_32(0x5083009c04,0x00000004); //Credit
	mmio_write_32(0x5083009c08,0x00000004); //Credit
	mmio_write_32(0x5083009c0c,0x00000004); //Credit
	mmio_write_32(0x5083009c10,0x00000004); //Credit
	mmio_write_32(0x5083009c14,0x00000004); //Credit
	mmio_write_32(0x5083009c18,0x00000004); //Credit
	mmio_write_32(0x5083009c1c,0x00000004); //Credit
	...
	mmio_write_32(0x508300a3c0,0x00000003); //Active Memory Interleave Group Register 
	mmio_write_32(0x508300a3c4,0x00000100); //Memory Interleave Function Select Register 
	mmio_write_32(0x508300a400,0x81400000); //General Purpose Region Attribute Register
	mmio_write_32(0x508300a404,0x00000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x508300a408,0x00000000); //General Purpose Region addr high 51:44
	mmio_write_32(0x508300a410,0x01600200); //General Purpose Region Attribute Register
	mmio_write_32(0x508300a414,0x01000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x508300a418,0x00000000); //General Purpose Region addr high 51:44
	mmio_write_32(0x508300ac00,0x00000004); //Credit
	mmio_write_32(0x508300ac04,0x00000004); //Credit
	mmio_write_32(0x508300ac08,0x00000004); //Credit
	mmio_write_32(0x508300ac0c,0x00000004); //Credit
	mmio_write_32(0x508300ac10,0x00000004); //Credit
	mmio_write_32(0x508300ac14,0x00000004); //Credit
	mmio_write_32(0x508300ac18,0x00000004); //Credit
	mmio_write_32(0x508300ac1c,0x00000004); //Credit
	...
	mmio_write_32(0x508300b3c0,0x00000003); //Active Memory Interleave Group Register 
	mmio_write_32(0x508300b3c4,0x00000100); //Memory Interleave Function Select Register 
	mmio_write_32(0x508300b400,0x81400000); //General Purpose Region Attribute Register
	mmio_write_32(0x508300b404,0x00000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x508300b408,0x00000000); //General Purpose Region addr high 51:44
	mmio_write_32(0x508300b410,0x01600200); //General Purpose Region Attribute Register
	mmio_write_32(0x508300b414,0x01000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x508300b418,0x00000000); //General Purpose Region addr high 51:44
	mmio_write_32(0x508300bc00,0x00000004); //Credit
	mmio_write_32(0x508300bc04,0x00000004); //Credit
	mmio_write_32(0x508300bc08,0x00000004); //Credit
	mmio_write_32(0x508300bc0c,0x00000004); //Credit
	mmio_write_32(0x508300bc10,0x00000004); //Credit
	mmio_write_32(0x508300bc14,0x00000004); //Credit
	mmio_write_32(0x508300bc18,0x00000004); //Credit
	mmio_write_32(0x508300bc1c,0x00000004); //Credit
	...
	mmio_write_32(0x508300c3c0,0x00000003); //Active Memory Interleave Group Register 
	mmio_write_32(0x508300c3c4,0x00000100); //Memory Interleave Function Select Register 
	mmio_write_32(0x508300c400,0x81400000); //General Purpose Region Attribute Register
	mmio_write_32(0x508300c404,0x00000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x508300c408,0x00000000); //General Purpose Region addr high 51:44
	mmio_write_32(0x508300c410,0x01600200); //General Purpose Region Attribute Register
	mmio_write_32(0x508300c414,0x01000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x508300c418,0x00000000); //General Purpose Region addr high 51:44
	mmio_write_32(0x508300cc00,0x00000004); //Credit
	mmio_write_32(0x508300cc04,0x00000004); //Credit
	mmio_write_32(0x508300cc08,0x00000004); //Credit
	mmio_write_32(0x508300cc0c,0x00000004); //Credit
	mmio_write_32(0x508300cc10,0x00000004); //Credit
	mmio_write_32(0x508300cc14,0x00000004); //Credit
	mmio_write_32(0x508300cc18,0x00000004); //Credit
	mmio_write_32(0x508300cc1c,0x00000004); //Credit
	...
	mmio_write_32(0x508300d3c0,0x00000003); //Active Memory Interleave Group Register 
	mmio_write_32(0x508300d3c4,0x00000100); //Memory Interleave Function Select Register 
	mmio_write_32(0x508300d400,0x81400000); //General Purpose Region Attribute Register
	mmio_write_32(0x508300d404,0x00000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x508300d408,0x00000000); //General Purpose Region addr high 51:44
	mmio_write_32(0x508300d410,0x01600200); //General Purpose Region Attribute Register
	mmio_write_32(0x508300d414,0x01000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x508300d418,0x00000000); //General Purpose Region addr high 51:44
	mmio_write_32(0x508300dc00,0x00000004); //Credit
	mmio_write_32(0x508300dc04,0x00000004); //Credit
	mmio_write_32(0x508300dc08,0x00000004); //Credit
	mmio_write_32(0x508300dc0c,0x00000004); //Credit
	mmio_write_32(0x508300dc10,0x00000004); //Credit
	mmio_write_32(0x508300dc14,0x00000004); //Credit
	mmio_write_32(0x508300dc18,0x00000004); //Credit
	mmio_write_32(0x508300dc1c,0x00000004); //Credit
	...
	mmio_write_32(0x508300e3c0,0x00000003); //Active Memory Interleave Group Register 
	mmio_write_32(0x508300e3c4,0x00000100); //Memory Interleave Function Select Register 
	mmio_write_32(0x508300e400,0x81400000); //General Purpose Region Attribute Register
	mmio_write_32(0x508300e404,0x00000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x508300e408,0x00000000); //General Purpose Region addr high 51:44
	mmio_write_32(0x508300e410,0x01600200); //General Purpose Region Attribute Register
	mmio_write_32(0x508300e414,0x01000000); //General Purpose Region addr low 43:12
	mmio_write_32(0x508300e418,0x00000000); //General Purpose Region addr high 51:44
	mmio_write_32(0x508300ec00,0x00000004); //Credit
	mmio_write_32(0x508300ec04,0x00000004); //Credit
	mmio_write_32(0x508300ec08,0x00000004); //Credit
	mmio_write_32(0x508300ec0c,0x00000004); //Credit
	mmio_write_32(0x508300ec10,0x00000004); //Credit
	mmio_write_32(0x508300ec14,0x00000004); //Credit
	mmio_write_32(0x508300ec18,0x00000004); //Credit
	mmio_write_32(0x508300ec1c,0x00000004); //Credit
	...
	//top_csr                       base address:0x50830f_e000
	mmio_write_32(0x50830fe000,0x00000003); //reg_itlv_bit
	//sys_global_register_blk       base address:0x50830f_f000
}
#else
void sg2380_ncore_init(void)
{
	printf("SG2380 ncore init\n");
	...
	mmio_write_32(0x5083000b2c,0x40000000);
	mmio_write_32(0x5083000b3c,0x40000000);
	mmio_write_32(0x5083000c00,0x00020804); //Credit
	...
	mmio_write_32(0x5083001b2c,0x40000000);
	mmio_write_32(0x5083001b3c,0x40000000);
	mmio_write_32(0x5083001c00,0x00020804); //Credit
	...
	mmio_write_32(0x5083002b2c,0x40000000);
	mmio_write_32(0x5083002b3c,0x40000000);
	mmio_write_32(0x5083002c00,0x00020804); //Credit
	...
	mmio_write_32(0x5083003b2c,0x40000000);
	mmio_write_32(0x5083003b3c,0x40000000);
	mmio_write_32(0x5083003c00,0x00020804); //Credit
	...
	mmio_write_32(0x5083004b2c,0x40000000);
	mmio_write_32(0x5083004b3c,0x40000000);
	mmio_write_32(0x5083004c00,0x00020a05); //Credit
	...
	mmio_write_32(0x5083005b2c,0x40000000);
	mmio_write_32(0x5083005b3c,0x40000000);
	mmio_write_32(0x5083005c00,0x00020a05); //Credit
	...
	mmio_write_32(0x5083006b2c,0x40000000);
	mmio_write_32(0x5083006b3c,0x40000000);
	mmio_write_32(0x5083006c00,0x00020a05); //Credit
