...
void ncore_direct_config() {
	...
	mmio_write_32(0x5083000040,0x00000200); //coattach
	...
	//mmio_write_32(0x5083000200,0x000f0000); //QOS
	...
	mmio_write_32(0x5083000400,0x81700000); //General Purpose Region Attribute Register
	...
	mmio_write_32(0x5083000900,0x00420000);
	...
	mmio_write_32(0x5083000c00,0x00000604); //Credit
	mmio_write_32(0x5083000c04,0x00000604); //Credit
	mmio_write_32(0x5083000c08,0x00000604); //Credit
	mmio_write_32(0x5083000c0c,0x00000604); //Credit
	mmio_write_32(0x5083000c10,0x00000604); //Credit
	mmio_write_32(0x5083000c14,0x00000604); //Credit
	mmio_write_32(0x5083000c18,0x00000604); //Credit
	mmio_write_32(0x5083000c1c,0x00000604); //Credit
	//P670_1_ace_caiu	base address:0x508300_1000
	mmio_write_32(0x5083001040,0x00000200); //coattach
	...
	mmio_write_32(0x5083001400,0x81700000); //General Purpose Region Attribute Register
	...
	mmio_write_32(0x5083001900,0x00420000);
	...
	mmio_write_32(0x5083001c00,0x00000604); //Credit
	mmio_write_32(0x5083001c04,0x00000604); //Credit
	mmio_write_32(0x5083001c08,0x00000604); //Credit
	mmio_write_32(0x5083001c0c,0x00000604); //Credit
	mmio_write_32(0x5083001c10,0x00000604); //Credit
	mmio_write_32(0x5083001c14,0x00000604); //Credit
	mmio_write_32(0x5083001c18,0x00000604); //Credit
	mmio_write_32(0x5083001c1c,0x00000604); //Credit
	//P670_2_ace_caiu	base address:0x508300_2000
	mmio_write_32(0x5083002040,0x00000200); //coattach
	...
	mmio_write_32(0x5083002400,0x81700000); //General Purpose Region Attribute Register
	...
	mmio_write_32(0x5083002900,0x00420000);
	...
	mmio_write_32(0x5083002c00,0x00000604); //Credit
	mmio_write_32(0x5083002c04,0x00000604); //Credit
	mmio_write_32(0x5083002c08,0x00000604); //Credit
	mmio_write_32(0x5083002c0c,0x00000604); //Credit
	mmio_write_32(0x5083002c10,0x00000604); //Credit
	mmio_write_32(0x5083002c14,0x00000604); //Credit
	mmio_write_32(0x5083002c18,0x00000604); //Credit
	mmio_write_32(0x5083002c1c,0x00000604); //Credit
	//P670_3_ace_caiu	base address:0x508300_3000
	mmio_write_32(0x5083003040,0x00000200); //coattach
	...
	mmio_write_32(0x5083003400,0x81700000); //General Purpose Region Attribute Register
	...
	mmio_write_32(0x5083003900,0x00420000);
	...
	mmio_write_32(0x5083003c00,0x00000604); //Credit
	mmio_write_32(0x5083003c04,0x00000604); //Credit
	mmio_write_32(0x5083003c08,0x00000604); //Credit
	mmio_write_32(0x5083003c0c,0x00000604); //Credit
	mmio_write_32(0x5083003c10,0x00000604); //Credit
	mmio_write_32(0x5083003c14,0x00000604); //Credit
	mmio_write_32(0x5083003c18,0x00000604); //Credit
	mmio_write_32(0x5083003c1c,0x00000604); //Credit
	//GPU_0_acelite_io_aiu		  base address:0x508300_4000
	mmio_write_32(0x5083004040,0x00000000); //coattach
	...
	mmio_write_32(0x5083004400,0x81700000); //General Purpose Region Attribute Register
	...
	mmio_write_32(0x5083004900,0x00420000);
	...
	mmio_write_32(0x5083004c00,0x00000805); //Credit
	mmio_write_32(0x5083004c04,0x00000805); //Credit
	mmio_write_32(0x5083004c08,0x00000805); //Credit
	mmio_write_32(0x5083004c0c,0x00000805); //Credit
	mmio_write_32(0x5083004c10,0x00000805); //Credit
	mmio_write_32(0x5083004c14,0x00000805); //Credit
	mmio_write_32(0x5083004c18,0x00000805); //Credit
	mmio_write_32(0x5083004c1c,0x00000805); //Credit
	//PCIe_0_acelite_io_aiu		base address:0x50_8300_5000
	mmio_write_32(0x5083005040,0x00000000); //coattach
	...
	mmio_write_32(0x50830053a0,0x0000000); //Boot Region Attribute Register
	...
	mmio_write_32(0x5083005400,0x81700000); //General Purpose Region Attribute Register
	...
	mmio_write_32(0x5083005900,0x00420000);
	...
	mmio_write_32(0x5083005c00,0x00000805); //Credit
	mmio_write_32(0x5083005c04,0x00000805); //Credit
	mmio_write_32(0x5083005c08,0x00000805); //Credit
	mmio_write_32(0x5083005c0c,0x00000805); //Credit
	mmio_write_32(0x5083005c10,0x00000805); //Credit
	mmio_write_32(0x5083005c14,0x00000805); //Credit
	mmio_write_32(0x5083005c18,0x00000805); //Credit
	mmio_write_32(0x5083005c1c,0x00000805); //Credit
	//USB_PERI_0_acelite_io_aiu	 base address:0x508300_6000
	mmio_write_32(0x5083006040,0x00000000); //coattach
	...
	mmio_write_32(0x50830063a0,0x0000000); //Boot Region Attribute Register
	...
	mmio_write_32(0x5083006400,0x81700000); //General Purpose Region Attribute Register
	...
	mmio_write_32(0x5083006900,0x00420000);
	...
	mmio_write_32(0x5083006c00,0x00000805); //Credit
	mmio_write_32(0x5083006c04,0x00000805); //Credit
	mmio_write_32(0x5083006c08,0x00000805); //Credit
	mmio_write_32(0x5083006c0c,0x00000805); //Credit
	mmio_write_32(0x5083006c10,0x00000805); //Credit
	mmio_write_32(0x5083006c14,0x00000805); //Credit
	mmio_write_32(0x5083006c18,0x00000805); //Credit
	mmio_write_32(0x5083006c1c,0x00000805); //Credit
	...
	mmio_write_32(0x5083007400,0x81700000); //General Purpose Region Attribute Register
	...
	mmio_write_32(0x5083007c00,0x00000010); //Credit
	...
	mmio_write_32(0x5083008400,0x81700000); //General Purpose Region Attribute Register
	...
	mmio_write_32(0x5083008c04,0x00000010); //Credit
	...
	mmio_write_32(0x5083009400,0x81700000); //General Purpose Region Attribute Register
	...
	mmio_write_32(0x5083009c08,0x00000010); //Credit
	...
	mmio_write_32(0x508300a400,0x81700000); //General Purpose Region Attribute Register
	...
	mmio_write_32(0x508300ac0c,0x00000010); //Credit
	...
	mmio_write_32(0x508300b400,0x81700000); //General Purpose Region Attribute Register
	...
	mmio_write_32(0x508300bc10,0x00000010); //Credit
	...
	mmio_write_32(0x508300c400,0x81700000); //General Purpose Region Attribute Register
	...
	mmio_write_32(0x508300cc14,0x00000010); //Credit
	...
	mmio_write_32(0x508300d400,0x81700000); //General Purpose Region Attribute Register
	...
	mmio_write_32(0x508300dc18,0x00000010); //Credit
	...
	mmio_write_32(0x508300e400,0x81700000); //General Purpose Region Attribute Register
	...
	mmio_write_32(0x508300ec1c,0x00000010); //Credit
