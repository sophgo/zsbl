...
#define FIELD_VAL(val, mask) ((val * LSB(mask)) & (mask))
#define READ_FIELD(reg, mask)  (((reg) & (mask)) / LSB(mask))
#define PREP_FIELD(reg, mask, val) (CLEAR_FIELD(reg, mask) | FIELD_VAL(val, mask))
