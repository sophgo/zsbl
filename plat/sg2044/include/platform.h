...
#if (CONFIG_RAM_START==0xc00000000)
#define OPENSBI_ADDR	0xc80000000
#define KERNEL_ADDR	0xc80200000
#define DEVICETREE_ADDR	0xc88000000
#define RAMFS_ADDR	0xc8b000000
#else
