...
//static int test_flag(struct pka_dev *dev, struct pka_param *param)
//{
//	u32 saved_flags;
//	int flag_shift;
...
//static int set_flag(struct pka_dev *dev, struct pka_param *param)//const char *func, const char *name)
//{
//	u32 mask, prev_flags;
//	int rc;
...
//static void release_dev(struct pka_dev *dev)
//{	
//	free(dev->regs);
//	free(dev);
//}
