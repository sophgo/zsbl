...
static void param_last_init(union akchipher_param *param)
{
...
int sm2_verify(struct akchipher_alg *alg, union akchipher_param *param)
{
	int ret;
...
static int sm2_alg_init(struct akchipher_alg *sm2, struct pka_dev *dev)
{
	/* init alg name */
